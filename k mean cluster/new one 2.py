...
#load dataset
dataset=pd.read_csv('C:/Users/altaf/OneDrive/Documents/loan_train11.csv')
...
x3=dataset["Education"].mode()[0]
dataset["Education"].fillna(x2,inplace=True)


x4=dataset["Self_Employed"].mode()[0]
dataset["Self_Employed"].fillna(x4,inplace=True)

x5=dataset["Applicant_Income"].mode()[0]
dataset["Applicant_Income"].fillna(x5,inplace=True)

x6=dataset["Loan_Amount"].mode()[0]
dataset["Loan_Amount"].fillna(x6,inplace=True)

x7=dataset["Term"].mode()[0]
dataset["Term"].fillna(x6,inplace=True)

x8=dataset["Credit_History"].mode()[0]
dataset["Credit_History"].fillna(x6,inplace=True)

x9=dataset["Area"].mode()[0]
dataset["Area"].fillna(x6,inplace=True)
...
Area=set(dataset['Area'])
dataset['Area']=dataset['Area'].map({'Rural':0,'Semiurban':1,'Urban':2}).astype(int)
print(dataset.head)
